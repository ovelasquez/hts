...
<div id="content" class="wrapper">
 <?php if ($page['featured']): ?><div class="welcome"><?php print render($page['featured']); ?></div><?php endif; ?>
 	...
 	<div class="divider"></div>
        ...
        <?php if (!$page['slider']): ?><?php print render($page['content']); ?><?php endif; ?>
...
<?php if ($page['postscript_first'] && !$page['postscript_second']){ ?>
	<div ><div id="postscript-first" class="postscript-first-m"><?php print render($page['postscript_first']); ?></div></div>
    
    <div class="clear hide"></div>
    <div class="divider hide"></div><?php  ?>    
<?php }else if ($page['postscript_first']):?><div class="one-two"><div id="postscript-first"><?php print render($page['postscript_first']); ?></div></div>
...
<?php if ($page['postscript_third'] && !$page['postscript_fourth']){ ?><div ><div id="postscript-first" class="postscript-first-m"><?php print render($page['postscript_third']); ?></div></div>
    
    <div class="clear hide"></div>
    <div class="divider hide"></div><?php  ?>    
<?php }else if ($page['postscript_third']): ?><div class="one-two"><div id="postscript-third"><?php print render($page['postscript_third']); ?></div> </div>
